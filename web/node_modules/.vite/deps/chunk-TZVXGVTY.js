...
// node_modules/.pnpm/@tanstack+router-devtools-core@1.132.51_@tanstack+router-core@1.132.47_@types+node@24.7_5b74436deda66874c4c80b16333e5493/node_modules/@tanstack/router-devtools-core/dist/BaseTanStackRouterDevtoolsPanel-CaAQWNvS.js
...
var _tmpl$8 = template(`<div><span>masked`);
var _tmpl$9 = template(`<div role=button><div>`);
var _tmpl$0 = template(`<div><div><div>Cached Matches</div><div>age / staleTime / gcTime</div></div><div>`);
var _tmpl$1 = template(`<div><div>Match Details</div><div><div><div><div></div></div><div><div>ID:</div><div><code></code></div></div><div><div>State:</div><div></div></div><div><div>Last Updated:</div><div></div></div></div></div><div>Explorer</div><div>`);
var _tmpl$10 = template(`<div>Loader Data`);
var _tmpl$11 = template(`<div><div><span>Search Params</span></div><div>`);
var _tmpl$12 = template(`<span style=margin-left:0.5rem;>`);
var _tmpl$13 = template(`<button type=button style=cursor:pointer; aria-label="Copy value to clipboard">`);
function Logo(props) {
  const {
...
function CopyButton({
  ...
  return (() => {
    ...
    createRenderEffect(() => setAttribute(_el$71, "title", copied() ? "Copied!" : "Copy"));
    return _el$71;
  })();
}
...
//# sourceMappingURL=chunk-TZVXGVTY.js.map
